...
class PostgresEngine:
    ...
    #     """Execute a SQL query."""
    #     return self._run_as_sync(self.__aexecute(query, params))
    ...
    async def ainit_chat_history_table(self, table_name: str) -> None:
        ...
        return await self._ainit_chat_history_table(
            table_name,
        )
        # )
    ...
    async def ainit_document_table(
        ...
        """
        # return self._run_as_async(
        return await self._ainit_document_table(
            table_name,
            content_column,
            metadata_columns,
            metadata_json_column,
