...
class PostgresSaver(BaseCheckpointSaver[str]):
    """Checkpoint stored in PostgreSQL database."""
    ...
    async def create(
        ...
        Args:
            engine (PostgresSaver): PostgreSQL engine to use.
        ...
        """
        coro = AsyncPostgresSaver.create(engine, schema_name, serde)
    ...
    async def alist(
        ...
        """
        yield await self._engine._run_as_async(
            self.__checkpoint.alist(config, filter, before, limit)
        )
    ...
    def list(
        ...
        """List checkpoints from PostgreSQL database.
    ...
    def get_tuple(self, config: RunnableConfig) -> Optional[CheckpointTuple]:
        """Get a checkpoint tuple from PostgreSQL.
    ...
    async def aput_writes(
        ...
        await self._engine._run_as_async(
            self.__checkpoint.aput_writes(config, writes, task_id)
        )
